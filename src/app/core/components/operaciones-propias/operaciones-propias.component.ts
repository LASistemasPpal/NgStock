...
export class OperacionesPropiasComponent implements OnInit {
  ...
  constructor(
    ...
    this.dtColumnas = [
      ...
      { title:  this.colorGrid.tablaH('Cmi Comp'), data: null, className: 'dt-body-right', render: (data: any, type: any, row: any, meta) => {
        return display_x(data.ComisionComprador, 8, 2);
      } },
      { title:  this.colorGrid.tablaH('Cmi Vend'), data: null, className: 'dt-body-right', render: (data: any, type: any, row: any, meta) => {
      ...
      { title:  this.colorGrid.tablaH('Ofert C'), data: 'NumeroOfertaCompra', className: 'dt-body-right' },
      { title:  this.colorGrid.tablaH('Ofert V'), data: 'NumeroOfertaVenta', className: 'dt-body-right' },
      ...
      { title:  this.colorGrid.tablaH('Nominal'), data: null, className: 'dt-body-right',  render: (data: any, type: any, row: any, meta) => {
      ...
      { title:  this.colorGrid.tablaH('Transado'), data: null, className: 'dt-body-right',  render: (data: any, type: any, row: any, meta) => {
        if (data.MonedaTransada === 'DOP') {
